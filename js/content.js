...
(function () {
  ...
  function applyContent(data) {
    ...
    var instagramLink = document.querySelector(".instagram-cta a[href*='instagram']");
    ...
    var contactEmailBtn = document.querySelector(".contact-content .btn-primary[href^='mailto']");
    ...
    var contactRep = document.querySelector(".contact-rep");
    if (contactRep && data.contact) {
      contactRep.innerHTML = "Representation: " + escapeHtml(data.contact.repName || "") + ", " + escapeHtml(data.contact.repAgency || "") + " — <a href=\"mailto:" + escapeHtml(data.contact.repEmail || "") + "\" class=\"contact-link\">" + escapeHtml(data.contact.repEmail || "") + "</a>";
    }

    var contactRtsLogo = document.querySelector(".contact-rts-logo");
    if (contactRtsLogo && data.contact) {
      if (data.contact.agencyWebsiteUrl) contactRtsLogo.href = data.contact.agencyWebsiteUrl;
      var logoImg = contactRtsLogo.querySelector("img");
      if (logoImg && data.contact.agencyLogoUrl) logoImg.src = data.contact.agencyLogoUrl;
    }
  ...
  function fillResumeTable(sectionId, rows) {
    var section = document.querySelector("[aria-labelledby=\"" + sectionId + "\"]");
    if (!section) return;
